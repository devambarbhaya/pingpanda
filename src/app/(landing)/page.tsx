        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    From new users sign ups to successful payments, PingPanda
                    notifies you for all the critical events in your SaaS
                  </p>
                </div>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="absolute inset-px pointer-events-none rounded-lg shadow ring-1 ring-black/5" />
            </div>

            {/* Fourth Element of Bento Grid */}
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute bottom-0 left-5 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                ...
                for two months now and seeing sales popup in real-time is super
                satisfying
              </p>
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@itsHetviShah</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                PingPanda is paying off for our Saas. Nice to have a simple way
                to see how we are doing day-to-day. Definitely makes our lives
                easier.
              </p>
              <div className="flex flex-col justify-center lg:justify-start sm:flex-row items-center sm:items-start gap-4 mt-2">
                <Image
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-sm text-gray-600">@manas_shah</p>
                </div>
              </div>
            </div>
          </div>
